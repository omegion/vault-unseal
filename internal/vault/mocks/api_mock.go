...
// UnsealWithShards mocks base method
func (m *MockAPIInterface) UnsealWithShards(arg0 []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UnsealWithShards", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// UnsealWithShards indicates an expected call of UnsealWithShards
func (mr *MockAPIInterfaceMockRecorder) UnsealWithShards(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UnsealWithShards", reflect.TypeOf((*MockAPIInterface)(nil).UnsealWithShards), arg0)
}
